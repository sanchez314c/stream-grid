...
from videowall.config.settings import DEFAULT_GRID_ROWS, DEFAULT_GRID_COLS
from videowall.core.display_manager import DisplayManager
from videowall.core.video_manager import VideoManager
from videowall.core.layout_manager import LayoutManager
...
class VideoWall(QMainWindow):
    ...
    def __init__(self, app, m3u8_links=None, local_videos=None, screen=None, parent=None):
        ...
        self.display_manager.initialize_grid(animator=False)
