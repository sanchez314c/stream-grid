...
## Package.json Configuration (UPDATED - WORKING VERSION)

**IMPORTANT FIXES APPLIED**:
- Fixed `linux.desktop` configuration format (now uses `entry` object)
- Removed deprecated `appImage.systemIntegration` property
- Updated icon paths to use `resources/icons/` structure
- All paths verified and tested working
